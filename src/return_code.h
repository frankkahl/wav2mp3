...
#define RET_CODE_INVALID_ARGUMENTS 1
#define RET_CODE_CONVERTING_SOME_FILES_FAILED 2
#define RET_ABORTED_BY_SIGINT_OR_SIGTERM 3
#define RET_CODE_DIR_ITER_FAILED 4
#define RET_CODE_EXCEPTION_CAUGHT 5
#define RET_CODE_PTHREAD_ERROR 6
#define RET_CODE_LAME_ERROR 7
